  ...
  <div class="grid place-items-center h-screen">
    <div class="bg-white shadow-sm p-4">
      <div class="mx-40 mt-3 mb-8">
        ...
        <p class="text-slate-400 -ml-8">If you have no account, <span class="text-blue-800 cursor-pointer"
            @click="$router.push('/')">Sign Up</span></p>
      </div>
      <form name="login">
        <div class="my-4">
          <label for="email" class="text-black text-sm mb-2">Email Address</label>
          <div class="flex">
            <input v-model="state.email" class="w-full py-1 text-gray-700 outline outline-OutlineColor" id="email"
              type="email" placeholder="Type your email address here" />
          </div>
        ...
        <div class="">
          ...
          <div class="flex">
            <input v-model="state.password" class="w-full py-1  text-gray-700 outline-OutlineColor outline"
